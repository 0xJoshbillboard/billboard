...
import { Card, CardContent, CardMedia, Typography, Container, Stack } from '@mui/material';
...
export default function SDK() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        {ads.map((ad) => (
          <Card key={ad.ipfsHash} sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            <CardMedia component="img" height="200" image={ad.url} alt={ad.description} sx={{ objectFit: 'contain' }} />
            <CardContent>
